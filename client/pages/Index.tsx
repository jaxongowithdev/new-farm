...
const Index = () => {
  ...
  const gameCategories = [
    ...
    },
    {
      ...
      subtitle: "Advanced Space Education",
      description: "Master physics and astronomy through space missions",
      icon: <Sparkles className="w-8 h-8" />,
      gradient: "from-indigo-600 to-purple-600",
      route: "/galactic",
      difficulty: ["Pilot", "Engineer", "Scientist"],
      players: "1.2k",
      rating: 4.9,
    },
    {
      ...
      subtitle: "Cute Animal Learning Fun",
      description: "Learn math with adorable farm animals and fun activities",
      icon: <Flower className="w-8 h-8" />,
      gradient: "from-green-500 to-yellow-500",
      route: "/farm",
      difficulty: ["Easy", "Fun", "Super"],
      players: "3.1k",
      rating: 5.0,
    },
  ];
